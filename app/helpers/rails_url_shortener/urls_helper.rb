...
module RailsUrlShortener
  module UrlsHelper
    ...
    def short_url(url, owner: nil, key: nil, kind: nil, starts_at: nil, expires_at: nil, paused: false, category: nil, forward_query_params: nil, password: nil, tracked: true, custom_host: nil, url_options: {})
      # generate
      ...
      if url_object.errors.empty?
        ...
        options = {
          ...
          action: 'show',
          key: url_object.key,
          host: RailsUrlShortener.resolve_host(url_object.custom_host)
        }.merge(url_options)
